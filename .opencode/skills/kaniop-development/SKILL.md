---
name: kaniop-development
description: Kaniop architecture, Rust controller conventions, commands, testing, and repository workflows. Use when changing Kaniop source code, tests, CRDs, configuration, or documentation.
---
