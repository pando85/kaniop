...
kubectl delete job minio-setup-bucket minio-setup-lock-bucket -n "$NAMESPACE" --ignore-not-found=true
...
kubectl delete secret minio-tls minio-creds minio-creds-invalid minio-creds-limited -n "$NAMESPACE" --ignore-not-found=true
