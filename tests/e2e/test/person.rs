...
async fn person_lifecycle() {
    ...
    assert!(
        gidnumber.is_some(),
        "gidnumber should be auto-generated by Kanidm when posix_attributes are set"
    );
    ...
    assert!(
        gidnumber.is_some(),
        "gidnumber should be preserved after loginshell update"
    );
    assert_eq!(loginshell.unwrap(), "/bin/bash");
    ...
    assert_eq!(gidnumber.unwrap(), "555555");
    assert_eq!(loginshell.unwrap(), "/bin/bash");
    ...
    assert!(
        gidnumber.is_some(),
        "gidnumber should be preserved when posix_attributes is removed but gidnumber was manually set"
    );
    assert_eq!(loginshell.unwrap(), "/bin/bash");
