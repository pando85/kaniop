...
- ci: Skip tests in documentation only changes
- kanidm: Allow origin configuration
- kanidm: Renew replication certificates
  - **BREAKING**: Replica certificates secrets has to be recreated after
this change for being able to renew them.

### Documentation

- book: Update to use versioned example links
- kanidm: Clarify ingress requirements about TLS and session affinity
- kanidm: Add usage guide and update docs

## [v0.0.0-beta.5](https://github.com/pando85/kaniop/tree/v0.0.0-beta.5) - 2025-10-11

### Fixed

- kanidm: Not include ingress `extraTlsHosts` in non TLS configuration

### Documentation

- kanidm: Improve namespace selector docs
