...
E2E_SHARD_FILTER_kanidm-data := test::kanidm::restore test::kanidm::backup restore_completed_implies restore_local_domain_mismatch restore_secondary_pvc_blocker restore_remote_ha_round_trip
